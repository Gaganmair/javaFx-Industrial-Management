...
<h2 align="center">APPLY ONLINE VIEW</h2>
<%
     int sumcount=0;
          Statement st;
          try {
          ...
          String query = "SELECT * from applynow";
         st = connection.createStatement();
          ResultSet rs = st.executeQuery(query);
%>

<form method="post" name="form">
<TABLE cellpadding="2" border="1" style="background-color: #ffffcc;" align="center" >
    <TR>
        <TD><b>Name</b></TD>
    ...
    <font size="+3" color="red"></b>
        ...
        <TR>
            <TD><FORM ACTION="orderview.jsp" method="post" >
           </TD>
        </TR>
    </TABLE>
        </form>
