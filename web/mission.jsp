...
<div id="templatemo_top_panel">
    ...
    <div id="templatemo_menu_login_section">
        ...
        <form method="post" action="mission.jsp">
    ...
    <div>
        <BR></BR>
        <center>  <strong><H1>MISSION</H1></strong></center>
        <br><br>
            <font size="3">
    ...
    Leveraging the talents for competitive success.Our Mission is to achieve Goals in Industry.
            </font>
