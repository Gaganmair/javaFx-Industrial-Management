...
<%
      try {
          ...
          String QueryString = "SELECT * from newevent";
          rs = statement.executeQuery(QueryString);
%>
<TABLE cellpadding="20" border="1" style="background-color: tan;color: #000000 " align="center" >
    <TR>
   
        <TD><b><font size="5">WHAT's NEW</font></b></TD>
         </TR>
    <%
    while (rs.next()) {
    %>
    ...
    <TR>
        ...
        <TD><font size="4"><%=rs.getString(2)%></TD>
    ...
    <font size="+3" color="red"></b>
        ...
        %>
    </font> </TABLE><TABLE align="center">
        <TR>
            <TD><FORM ACTION="news.jsp" method="post" >
           </TD>
        </TR>
    </TABLE>
